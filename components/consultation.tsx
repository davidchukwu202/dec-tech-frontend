    ...
    return (
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-brand-white mb-4">Thank You!</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-brand-white mb-4">Solar Consultation</h1>
        <p className="text-xl text-gray-400">Get expert advice tailored to your energy needs</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        {/* Consultation Form */}
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          <h2 className="text-2xl font-bold text-brand-white mb-6">Request Consultation</h2>
        ...
        <div className="space-y-8">
          <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
            <h3 className="text-2xl font-bold text-brand-white mb-6">What to Expect</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-brand-white font-semibold">Initial Assessment</h4>
                  <p className="text-gray-400 text-sm">We'll review your energy needs and site conditions</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-brand-white font-semibold">Custom Design</h4>
                  <p className="text-gray-400 text-sm">Tailored solar solution designed for your property</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 bg-brand-yellow rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <h4 className="text-brand-white font-semibold">Detailed Proposal</h4>
                  <p className="text-gray-400 text-sm">Complete pricing and installation timeline</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-brand-green/10 to-brand-yellow/10 border border-brand-green/20 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-brand-white mb-4">Why Choose DEC Tech?</h3>
